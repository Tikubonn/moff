...
class TreeBuilder (Builder):
  ...
  def add (self, anyone):
    if not isinstance(anyone, NodeConvertible):
      raise Exception("%s is not %s instance." % (anyone, NodeConvertible.__name__))
  ...
  def merge (self, builder):
    if isinstance(builder, type(self)):
      ...
      if self.get_indentation() < builder.get_indentation():
        ...
        raise TypeError("%s is not %s instance." % (builder, type(self).__name__))
    else:
      raise TypeError("%s is not %s instance." % (builder, TreeBuilder.__name__))
